...
$(document).ready(function(e) {
	...
	top = new Array("狂战士", "无畏战车", "猩红收割者", "正义天使", "亡灵战神", "迅捷斥候", "祖安怒兽", "蛮族之王", "武器大师", "炼金术士", "虚空恐惧",
		"祖安狂人", "刀锋舞者", "海洋之灾", "巨魔之王", "诺克萨斯统领", "熔岩巨兽", "荒漠屠夫", "齐天大圣", "暗夜猎手", "机械公敌", "沙漠死神",
		"圣锤之毅",
	...
	jungle = new Array("狂战士", "德邦总管", "远古恐惧", "无极剑圣", "祖安怒兽", "雪原双子", "武器大师", "痛苦之拥", "瘟疫之源", "死亡颂唱者",
		"殇之木乃伊",
	...
	//中路
	middle = new Array("黑暗之女", "正义巨像", "卡牌大师", "诡术妖姬", "猩红收割者", "正义天使", "符文法师", "亡灵战神", "麦林炮手", "蛮族之王",
		"堕落天使",
		"虚空恐惧", "冰晶凤凰", "虚空行者", "刀锋舞者", "海洋之灾", "英勇投弹手", "邪恶小法师", "诺克萨斯统领", "熔岩巨兽", "不祥之刃", "荒漠屠夫",
		"发条魔灵",
		"复仇焰魂", "机械公敌", "魔蛇之拥", "沙漠死神", "不屈之枪", "铁铠冥魂", "离群之刺", "德玛西亚之力", "虚空先知", "刀锋之影", "光辉女郎",
		"远古巫灵",
		"九尾妖狐", "法外狂徒", "潮汐海灵", "机械先驱", "爆破鬼才", "未来守护者", "冰霜女巫", "皎月女神", "暗黑元首", "暮光星灵", "虚空之女", "疾风剑豪",
		"虚空之眼", "岩雀", "影哨", "圣枪游侠", "影流之主", "时间刺客", "元素女皇", "暗裔剑魔", "沙漠皇帝", "解脱者", "万花通灵", "愁云使者",
		"封魔剑魂");
	//ADC
	adc = new Array("战争女神", "麦林炮手", "赏金猎人", "寒冰射手", "瘟疫之源", "皮城女警", "暗夜猎手", "探险家", "深渊巨口", "惩戒之箭", "爆破鬼才",
		"荣耀行刑官", "虚空之女", "疾风剑豪", "戏命师", "祖安花火", "暴走萝莉", "河流之王", "圣枪游侠", "沙漠玫瑰", "复仇之矛", "逆羽", "残月之肃");
	//辅助
	support = new Array("诡术妖姬", "牛头酋长", "众星之子", "赏金猎人", "寒冰射手", "堕落天使", "时光守护者", "瘟疫之源", "恶魔小丑", "琴瑟仙女",
		"风暴之怒",
		"天启者", "瓦洛兰之盾", "邪恶小法师", "诺克萨斯统领", "蒸汽机器人", "熔岩巨兽", "扭曲树精", "复仇焰魂", "不屈之枪", "曙光女神", "光辉女郎",
		"远古巫灵",
		"深海泰坦", "爆破鬼才", "仙灵女巫", "荆棘之兴", "星籁歌姬", "虚空之眼", "弗雷尔卓德之心", "河流之王", "涤魂圣枪", "唤潮鲛姬", "魔法猫咪",
		"魂锁典狱长",
		"星界游神", "幻翎", "镕铁少女", "血港鬼影", "腕豪", "炼金男爵");
	//所有英雄
	allHero = new Array();
