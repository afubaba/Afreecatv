...
$("#timesPromptInput,#chrysanthemumCheckBox,#chatPointsMode,#pictureIntetgralMode,#chatPointsMaxChangeMode,#chatSportMode,#robotChatCommondCheckboxId")
    .change(function () {
        if (this.checked) {
...
//上传状态
$("#pictureIntetgralMode,#halfHourPrompt,#chatPointsMaxChangeMode,#chatPointsMode,#chatSportMode,#robotChatCommondCheckboxId,#delayInputId")
    .change(
        function () {
