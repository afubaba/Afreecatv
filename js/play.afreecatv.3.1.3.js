        ...
        var loadLibInterval = setInterval(function () {
            ...
            if (pageLang != null) {
                ...
                $.getJSON(jsonlink, function (result) {
                    ...
                    var paSettingIndexdbURL = host + "js/play.afreecatv.setting.3.1.3.indexdb.js";
                    dynamicLoading.js(paSettingIndexdbURL);
                    //websql.js
                    var paWebsqlURL = host + "js/play.afreecatv.3.1.3.websql.js";
                    dynamicLoading.js(paWebsqlURL);
                    var paIndexdbURL = host + "js/play.afreecatv.3.1.3.indexdb.js";
...
function environmentFunction() {
    ...
    $("#retrievalButtonId,#stopRetrievalMessage").click(function () {
        ...
        settData.chatPointsMaxChangeMode = chatPointsMaxChangeMode.checked;

        robotChatCommondCheckboxId = getDomById("robotChatCommondCheckboxId");
        settData.robotChatCommondCheckboxId = robotChatCommondCheckboxId.checked;
                                    ...
                                    if (callbackData.isAuthority) {
                                        ...
                                        if (tex.length == 4 || tex.length == 3) {
                                            randomDice(3, function (data) {
                                                ...
                                                randomDice(3, function (data) {
                                                    diceResult2 = data;
                                                    outputData(diceResult1, diceResult2)
                                                });
                                            });
                                        ...
                                        function outputData(diceResult1, diceResult2) {
                                                ...
                                                if (dicePointsResult2 > 0) {
                                                    ...
                                                    sendMessageCustom("@" + nickName + ":" + diceResult2
                                                        ...
                                                        makerNick + ":" + diceResult1
                                                            .diceString + "," + data[1].gamePoints + " 화패",
                                                        1, 2);
                                                } else {
                                                    sendMessageCustom("@" + nickName + ":" + diceResult2
                                                            .diceString + "," + data[0].gamePoints + "₍" +
