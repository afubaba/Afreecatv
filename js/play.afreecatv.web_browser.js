...
//中文控制
var pageLink = "play.afreecatv.zh_CN_web_browser.html";
...
if (htmlLang == "ko" || htmlLang == "ko_KR") {
	...
	//韩文控制
	pageLink = "play.afreecatv_ko_KR.web_browser.html"
}
...
function testStart() {
	function startButtonId() {
		...
		const indexdbURL = domain + "js/play.afreecatv.web_browser.indexdb.js";
		const mysqlURL = domain + "js/play.afreecatv.web_browser.mysql.js";
		const websqlURL = domain + "js/play.afreecatv.web_browser.websql.js";
		const settingURL = domain + "js/play.afreecatv.web_browser.setting.indexdb.js"
			...
			if ('undefined' != chat_area.children[initIndex] && typeof $("#" + initIndex).attr("data-isread") ==
				...
				if (idt != idt_last || tex != text_Last) {
					...
					if (isBarrage == 'close') {
						...
						// var idDom = $("#" + initIndex).prev().children("a")[0];
						//showTipBarrageFunction(showMessageText1);
