        ...
        var loadLibInterval = setInterval(function () {
            ...
            if (pageLang != null) {
                ...
                $.getJSON(jsonlink, function (result) {
                    ...
                    var paSettingIndexdbURL = host + "js/play.afreecatv.setting.3.1.5.indexdb.js";
                    dynamicLoading.js(paSettingIndexdbURL);
                    //websql.js
                    var paWebsqlURL = host + "js/play.afreecatv.3.1.5.websql.js";
                    dynamicLoading.js(paWebsqlURL);
                    var paIndexdbURL = host + "js/play.afreecatv.3.1.5.indexdb.js";
                    dynamicLoading.js(paIndexdbURL);
                    var paMysqlURL = host + "js/play.afreecatv.3.1.5.mysql.js";
...
function environmentFunction() {
    ...
    for (let ob of object) {
        ...
        $("#myTabbalePage").append("<div class='tab-pane noScroll myTabbalePageDiv' id='chapter" + linkIndex +
            ...
            ")'/></label>" +
            "&emsp;<label class='label' for='bj" + linkIndex + "'><span name='bj'>bj</span><input id='bj" + linkIndex +
            "' type='checkbox' onchange='changeCommandAuthorityManagementCustomSelectFunction(" + linkIndex +
            ")'></label>" +
            ...
            "' type='checkbox' onchange='changeCommandAuthorityManagementCustomSelectFunction(" + linkIndex +
            ")'/></label>" +
            "<br/><label class='label' for='hot" + linkIndex + "'><span name='hot'>hot</span><input id='hot" +
            linkIndex +
            "' type='checkbox' onchange='changeCommandAuthorityManagementCustomSelectFunction(" + linkIndex +
            ")'/></label>" +
            ...
            "' type='checkbox' onchange='changeCommandAuthorityManagementCustomSelectFunction(" + linkIndex +
            ")'/></label>" +
            "<br/><label class='label' for='fan" + linkIndex + "'><span name='fan'>fan</span><input id='fan" +
            linkIndex +
            "' type='checkbox' onchange='changeCommandAuthorityManagementCustomSelectFunction(" + linkIndex +
            ")'/></label>" +
            "&emsp;<label class='label' for='normal" + linkIndex +
            "' ><span name='normal'>normal</span><input id='normal" +
            ...
            linkIndex + ");'></li>" +
            "<li id='chooseNone' name='chooseNone'  class='btn btn-info' onclick='checkedToggle(\"none\"," +
            linkIndex +
            ");'></li>" +
