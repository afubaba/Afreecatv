...
dynamicLoading.css(domain + "css/play.afreecatv.web_browser.css");
...
//github远程
//dynamicLoading.js(domain +"js/afreecacook.js");

//加载本地JS
const commonURL = domain + "js/common.js";
const jsURL = domain + "js/play.afreecatv.web_browser.js";

//webview2 api
dynamicLoading.js(domain + "js/webview2.web_browser.js");
